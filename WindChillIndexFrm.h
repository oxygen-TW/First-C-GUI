///-----------------------------------------------------------------
///
/// @file      WindChillIndexFrm.h
/// @author    Oxygen
/// Created:   2017/8/19 ¤U¤È 07:13:29
/// @section   DESCRIPTION
///            WindChillIndexFrm class declaration
///
///------------------------------------------------------------------

#ifndef __WINDCHILLINDEXFRM_H__
#define __WINDCHILLINDEXFRM_H__
...
////Dialog Style Start
#undef WindChillIndexFrm_STYLE
#define WindChillIndexFrm_STYLE wxCAPTION | wxSYSTEM_MENU | wxMINIMIZE_BOX | wxCLOSE_BOX
////Dialog Style End

class WindChillIndexFrm : public wxFrame
{
	private:
		DECLARE_EVENT_TABLE();
